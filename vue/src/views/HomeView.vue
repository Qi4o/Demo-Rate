<template>
  <div style="width: 1000px; margin: 0 auto">
    ...
    <div style="width: 300px; margin: 10px auto; border: 1px solid #ccc; padding: 20px">
      <div>商品名称：巧克力</div>
      <div style="margin: 10px 0">商品价格：¥100</div>
      <div style="margin: 10px 0">商品评分：<el-rate style="display: inline-block" v-model="value" disabled allow-half show-text :colors="['#99A9BF', '#F7BA2A', '#FF9900']"></el-rate></div>
    </div>
      ...
      <div style="margin: 20px 0; text-align: left">
        <div style="padding: 10px 0; " v-for="item in comments" :key="item.id">
          ...
          <div style="display: flex">
            <div style="width: 60px"><el-avatar :size="size" :src="'https://cube.elemecdn.com/3/7c/3ea6beec64369c2642b92c6726f1epng.png'"></el-avatar></div>
            <div style="flex:1">
...
<!--              回复内容-->
              <div v-if="item.children.length" style="margin-left: 50px; padding: 5px 0; background-color: aliceblue; padding: 10px; border-radius: 10px">
